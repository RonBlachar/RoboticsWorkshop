...
def create_path(img_path):
    ...
    direction_array = plan_path(categorized_img_matrix, start=(0, 0),
                                jeep_size=JEEP_SIZE)
...
if __name__ == "__main__":
    ...
    path = create_path(
        "/Users/ronblachar/PycharmProjects/RoboticsWorkshop/images/WhatsApp Image 2024-06-11 at 14.18.47.jpeg")
